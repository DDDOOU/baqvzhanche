...
def main() -> int:
    ...
    for scene, pass_marker in suites:
        ...
        bad_markers = ("SCRIPT ERROR", "[UNIT CONFIG TEST] FAIL", "[PLAYER UNIT CONFIG TEST] FAIL", "[AUDIO SETTINGS TEST] FAIL", "[BATTLE LOG UI TEST] FAIL", "[SMOKE TEST] FAIL", "[LEVEL 02 TEST] FAIL", "[CAMPAIGN FRAMEWORK TEST] FAIL")
