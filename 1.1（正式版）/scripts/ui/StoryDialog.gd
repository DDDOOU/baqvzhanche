...
func _build_panel() -> void:
	...
	_portrait_left.anchor_left = 0.5
	_portrait_left.anchor_right = 0.5
	_portrait_left.offset_left = -638
	_portrait_left.offset_right = -438
	_portrait_left.offset_top = 76
	_portrait_left.offset_bottom = 276
	root.add_child(_portrait_left)

	_portrait_right = PORTRAITS.create_slot("PortraitRight")
	_portrait_right.anchor_left = 0.5
	_portrait_right.anchor_right = 0.5
	_portrait_right.offset_left = 438
	_portrait_right.offset_right = 638
	_portrait_right.offset_top = 76
	_portrait_right.offset_bottom = 276
...
func _show_next() -> void:
	...
	PORTRAITS.show_speaker(_portrait_left, _portrait_right,
		String(item.get("speaker", "无线电")), String(item.get("text", "")))
	visible = true
