...
func _build_interface() -> void:
	...
	main_panel.anchor_left = 0.045
	main_panel.anchor_top = 0.035
	main_panel.anchor_right = 0.955
	main_panel.anchor_bottom = 0.965
...
func _apply_responsive_layout() -> void:
	...
	main_panel.anchor_left = 0.015 if compact else 0.045
	main_panel.anchor_right = 0.985 if compact else 0.955
	main_panel.anchor_top = 0.015 if compact else 0.035
	main_panel.anchor_bottom = 0.985 if compact else 0.965
