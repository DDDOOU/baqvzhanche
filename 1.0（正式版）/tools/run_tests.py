...
def main() -> int:
    ...
    suites = (
        ...
        ("res://tests/audio_settings_test.tscn", "[AUDIO SETTINGS TEST] PASS"),
        ("res://tests/main_menu_cover_test.tscn", "[MAIN MENU COVER TEST] PASS"),
        ("res://tests/battle_log_ui_test.tscn", "[BATTLE LOG UI TEST] PASS"),
        ("res://tests/level_01_adversarial_test.tscn", "[LEVEL 01 ADVERSARIAL TEST] PASS"),
    ...
    for scene, pass_marker in suites:
        ...
        bad_markers = ("SCRIPT ERROR", "[UNIT CONFIG TEST] FAIL", "[PLAYER UNIT CONFIG TEST] FAIL", "[AUDIO SETTINGS TEST] FAIL", "[MAIN MENU COVER TEST] FAIL", "[BATTLE LOG UI TEST] FAIL", "[LEVEL 01 ADVERSARIAL TEST] FAIL", "[SMOKE TEST] FAIL", "[LEVEL 02 TEST] FAIL", "[CAMPAIGN FRAMEWORK TEST] FAIL")
